    ...
    for (const spec of specs){
        ...
        if ('quantization' in spec) {
            ...
            if (dtype === 'float32') {
                ...
                out[name] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$complex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["complex"])(realTensor, imageTensor);
                realTensor.dispose();
                imageTensor.dispose();
            } else {
                throw new Error(`Unsupported dtype in weight '${name}': ${dtype}`);
        ...
        if (dtype !== 'complex64') {
            out[name] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$tensor$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["tensor"])(values, shape, dtype);
        }
    }
    return out;
}
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-core_dist_io_d9afba4d._.js.map